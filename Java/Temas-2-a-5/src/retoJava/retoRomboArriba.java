...
public class retoRomboArriba {
  public static void main(String[] args) {
    ...
    for (forwardsIterator = 1; forwardsIterator < (userNum + 1);
         forwardsIterator++) {
      // Espacios previos
      for (spaceIterator = (spacerCount - forwardsIterator); spaceIterator > 0;
           spaceIterator--) {
        System.out.print(" ");
      }
    ...
    // for (backwardsIterator = (userNum - 1); backwardsIterator > 0;
    // backwardsIterator--) {
    //     // Espacios previos
    //     for (spaceIterator = (spacerCount - backwardsIterator); spaceIterator
    //     > 0; spaceIterator--) {
    //         System.out.print(" ");
    //     }
    //     // Cuenta hacia adelante
