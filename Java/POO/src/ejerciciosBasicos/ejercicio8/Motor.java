package ejerciciosBasicos.ejercicio8;
...
public class Motor {
    ...
    public Motor(int tipo_bomba, String tipo_fluido, String combustible) {
        this.tipoBomba = tipo_bomba;
        this.tipoFluido = tipo_fluido;
    ...
    public boolean dimeSiMotorEsParaAgua() {
        boolean motorEsParaAgua = (this.tipoBomba == 1) ? true : false;
